...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    @if (settings('social_logins') == "true")
      <div class="social-auth-links text-center">
        <p>- OR -</p>
        <a href="{{ route('auth-facebook') }}" class="btn btn-block btn-social btn-facebook btn-flat">
          <i class="fa fa-facebook"></i> Sign in using Facebook</a>
        <a href="#" class="btn btn-block btn-social btn-google btn-flat">
          <i class="fa fa-google-plus"></i> Sign in usingGoogle+
        </a>
      </div>
      @endif
        <!-- /.social-auth-links -->
      ...
      @if (settings('new_user_registration') == "true")
